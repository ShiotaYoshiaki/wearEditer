import { CHANGE_TO_GRID_VIEW, CHANGE_TO_LIST_VIEW, REQUEST_LOAD_ITEM_CONTENT_LIST, OPEN_ITEM_DETAIL_MODAL, CLOSE_ITEM_DETAIL_MODAL, REQUEST_CHANGE_TO_DISPLAY_ITEM_LIST, REQUEST_CLEAR_EDIT_TAG_ITEM_LIST, REQUEST_CLEAR_TO_DISPLAY_ITEM_LIST, CHANGE_TILE_WITH } from "../../constants/actionTypes";
...
export function changeTileWith() {
    return { type: CHANGE_TILE_WITH };
}
